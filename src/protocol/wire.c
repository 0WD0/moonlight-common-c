...
static bool message_type_is_request_response(uint16_t message_type) {
  switch (message_type) {
    ...
    case MOONLIGHT_PROTOCOL_V1_MESSAGE_GET_DISPLAY_LIST:
    ...
    case MOONLIGHT_PROTOCOL_V1_MESSAGE_PREPARE_SESSION_REPLACEMENT:
    case MOONLIGHT_PROTOCOL_V1_MESSAGE_COMMIT_SESSION_REPLACEMENT:
    case MOONLIGHT_PROTOCOL_V1_MESSAGE_CANCEL_SESSION_REPLACEMENT:
